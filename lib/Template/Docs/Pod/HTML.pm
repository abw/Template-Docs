#========================================================================
#
# Template::Docs::Pod::HTML
#
# DESCRIPTION
#   View module for Pod::POM which converts POD markup into HTML.
#
# AUTHOR
...
sub view_item {
    ...
    if (defined $title) {
        ...
        if (length $title) {
            ...
            $title = qq{<b id="item_${anchor}">$title</b>};
        }
    }
...
Template::Docs::Pod::HTML - convert POD to HTML
